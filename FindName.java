...
public class FindName extends JInternalFrame implements ActionListener {
	...
	FindName() {
		super("Tìm kiếm Customer [By Name]", false, true, false, true);
		setSize(350, 235);
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (obj == btnFind) {
			if (txtName.getText().equals("")) {
				JOptionPane.showMessageDialog(this, "Vui lòng điền tên khách hàng để tìm kiếm.",
	...
	void findRec() {
		...
		if (found == false) {
			JOptionPane.showMessageDialog(this, "Customer " + txtName.getText() + " không tồn tại.",
